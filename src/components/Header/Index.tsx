    ...
    <header className="flex justify-between gap-4">
      <div className="flex items-center gap-2 kindle:border kindle:border-accent kindle:rounded-[6px] kindle:gap-0">
        ...
        <Link
          ...
          href={'/'}
          className="pop:before:-top-1 pop:before:-right-1 pop:before:-z-10 relative pop:rotate-1 pop:bg-black pop:px-2 pop:py-1 kindle:pr-2 kindle:pl-2 pop:font-black pop:before:absolute pop:before:h-full pop:before:w-full pop:before:bg-accent kindle:mt-1"
        >
